...
bk <- read.xls("rollingsales_statenisland.xls",pattern="BOROUGH", perl = "/Strawberry/Perl/perl/bin/perl.exe")
...
## Added by Johnny Quick to save clean data for later use in analysis
write.csv(bk.homes, file = "statenisland_cleandata.csv")

setwd(paste(maind, "ANALYSIS", sep = "/"))
